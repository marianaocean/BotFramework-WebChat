...
export class HistoryView extends React.Component<HistoryProps, {}> {
    ...
    private autoscroll() {
        ...
        while (lastActivity && skipWaitingMessage && ['waitingString', 'waitingImage', 'waitingCss'].indexOf(lastActivity.id) >= 0 && i < this.props.activities.length) {
            i++;
        ...
        const lastActivityIsWaitingMessage = lastActivity && ['waitingString', 'waitingImage', 'waitingCss'].indexOf(lastActivity.id) >= 0;
