...
const localizedStrings: LocalizedStrings = {
    ...
    'th-th': {
        ...
        speak: 'พูด',
        alwaysSpeak: 'อ่านออกเสียงเสมอ',
        autoListenAfterSpeak: 'ใส่เสียงอัตโนมัติหลังจากที่พูด',
        close: 'ปิด',
        config: 'ติดตั้ง',
        timeInterval: 'ช่วงเวลาของข้อความ (วินาที)',
        tooManyUserSays: 'มีคำถามที่ตรงกันมากเกินไป ดังนั้นควรพิมเพิ่มอีกนิดหน่อย',
